...
<html lang="en">
	...
	<body class="dish-body">
		<nav class="navbar navbar-default">
            ...
            <div class="dish">
                <div class="dish-header">
                        <img class="img-responsive" src="images/classic-header.jpg">
                </div>
            <div class="nutrional">
                <div class="container">
                ...
                <div class="info">
                    <div class="container">
                        ...
                        <br><br>
                        <h1>Poached eggs with Broccoli, Tomatoes & wholemeal flat bread</h1>
                    </div>
                        <hr>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="ingredients">
                                ...
                                <br>
                                <ul>
                                    <li>100g thin-stemmed broccoli, trimmed and halved</li>
                                    <br>
                                    <li>200g cherry tomatoes on the vine</li>
                                    <br>
                                    <li>4 medium free-range eggs(fridge cold)</li>
                                    <br>
                                    <li>2 wholemeal flatbreads (see Goes well with for recipe)</li>
                                    <br>
                                    <li>2 tsp mixed seeds (such as sunflower, pumpkin, sesame and linseed)</li>
                                    <br>
			...
			<div class="method">
                            <h2>Method</h2>
                            <h3>1.</h3><p>Boil the kettle. Heat oven to 120C/100C fan/gas 1/2 and put an ovenproof 
				plate inside to warm up. Fill a wide-based saucepan one-third full of water from the 
				kettle and bring to the boil. Add the broccoli and cook for 2 mins. Add the tomatoes, 
				return to the boil and cook for 30 secs. Lift out with tongs or a slotted spoon and place 
				on the warm plate in the oven while you poach the eggs.</p>
				<h3>2.</h3><p>Return the water to a gentle simmer. Break the eggs into the pan, one at a time,
				and cook for 2 1/2 - 3 mins or until the whites are set and the yolks are runny.</p>
				<h3>3.</h3><p>Divide the flatbreads between the two plates and top with the broccoli and tomatoes. 
				Use a slotted spoon to drain the eggs, then place on top. Sprinkle with the seeds and drizzle with the oil. 
				Season with a little black pepper and the chilli flakes, and serve immediately.</p>
                        </div>
                    </div>
                </div>
          </div>
        ...
        <!--linking the footer class to the index page with the source folder it is located in-->
    </body>
</html>