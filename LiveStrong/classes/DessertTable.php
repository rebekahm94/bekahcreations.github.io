...
require_once 'classes/user1.php';//connecting the classes folder that has the user page inside it
...
class UserTable {//usertable class that can be used to connect to other pages
    ...
    public function insert($user) {//inserts the user information into the database table
        ...
        $sql = "INSERT INTO user1(email, username, password, role) "//the sql code thats the database, the insert sql into the user table with the name of columns
