		...
		<nav class="navbar navbar-default">
            ...
            <div class="dish">
                <div class="dish-header">
                        <img class="img-responsive" src="images/gobi-header.jpg">
                </div>
            <div class="nutrional">
                <div class="container">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="ingredients">
                                ...
                                <ul>
                                    ...
                                    <br>
                                    <li>500g potatoes, peeled and cut into small bite-sized pieces</li>
                                    <br>
                                    <li>300g cauliflower/broccoli florets</li>
                                    <br>
                                    <li>1 red pepper, deseeded and cut into bite-sized squares</li>
                                    <br>
                                    ...
                                    <li>200ml water</li>
                                    <br>
                                    <li>1 tsp artificial sweetener</li>
                                    <h3>To Serve</h3>
                                    <br>
                                    <li>3–4 tbsp fat free natural yogurt</li>
                                    <br>
                                    <li>A large handful of chopped mint and coriander</li>
                                </ul>
                            </div>
                        </div>
			...
			<div class="method">
                            <h2>Method</h2>
                            <h3>1.</h3><p>Spray a large, non-stick frying pan with low calorie cooking spray and place over a medium heat. Add the onions and stir-fry for 2–3 minutes.</p>
				<h3>2.</h3><p>Add the garlic granules, ginger and curry powder and stir-fry for 20–30 seconds. Add the potatoes, cauliflower/broccoli, red pepper and peas and stir-fry for 2–3 minutes.</p>
				<h3>3.</h3><p>Stir in the passata, water and sweetener and bring to the boil. Cover, reduce the heat to medium and cook, stirring occasionally, for 15–20 minutes, or until the vegetables are 
                                    tender. Serve drizzled with the yogurt and garnished with the chopped mint and coriander. Serve with steamed basmati rice, if desired.</p>
                        </div>
                    </div>
                </div>
          </div>
