...
<html lang="en">
    ...
    <body>
        ...
        <div class="cardioHead">
            <img class="img-responsive" src="images/bodyBuildingHead.jpg">
            <div class="cardio-workouts">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <h3>Upper Body Super Sets</h3>
                            <div class="videoWrapper">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/3RcDkEOJV8c" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="cardio-info">
                                <p><img class="img-circle" src="images/time.png">  3 Sets, 5-8 Reps</p>
                                <p><img class="img-circle" src="images/calorieBurn.png"> 207 - 364 Calories</p>
                                <p><img class="img-circle" src="images/weightLiftingIconSmall.png"> Body Building</p>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <h3>Lower Body Super Sets</h3>
                            <div class="videoWrapper">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/T9kt9tqdAeo" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="cardio-info">
                                <p><img class="img-circle" src="images/time.png">  3 Sets, 5-8 Reps</p>
                                <p><img class="img-circle" src="images/calorieBurn.png"> 207 - 364 Calories</p>
                        ...
                        <div class="col-lg-4 col-md-4 hidden-sm hidden-xs">
                            <h3>Full Body w/ Dumbells</h3>
                            <div class="videoWrapper">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/l0gDqsSUtWo" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="cardio-info">
                                <p><img class="img-circle" src="images/time.png">  60 Minutes</p>
                                <p><img class="img-circle" src="images/calorieBurn.png"> 207 - 364 Calories</p>
                                <p><img class="img-circle" src="images/weightLiftingIconSmall.png"> Body Building</p>
                                <button type="button" class="btn btn-primary">Add to Favourites</button>
                                <button type="button" class="btn btn-primary">Add to Calendar</button>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <h3>Ultimate Leg Workout</h3>
                            <div class="videoWrapper">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/qyOe2ZXGMQ8" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="cardio-info">
                                <p><img class="img-circle" src="images/time.png">  60 Minutes</p>
                                <p><img class="img-circle" src="images/calorieBurn.png"> 207 - 364 Calories</p>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <h3>Ultimate Leg Workout</h3>
                            <div class="videoWrapper">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/_Vy8BDYGvXk" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="cardio-info">
                                <p><img class="img-circle" src="images/time.png">  60 Minutes</p>
                                <p><img class="img-circle" src="images/calorieBurn.png"> 207 - 364 Calories</p>
                        ...
                        <div class="col-lg-4 col-md-4 hidden-sm hidden-xs">
                            <h3>Ultimate Back Workout</h3>
                            <div class="videoWrapper">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/lA7dbOmxs5I" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="cardio-info">
                                <p><img class="img-circle" src="images/time.png">  60 Minutes</p>
                                <p><img class="img-circle" src="images/calorieBurn.png"> 207 - 364 Calories</p>
